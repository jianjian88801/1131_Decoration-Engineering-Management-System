    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="lixiangxiangmuId" name="lixiangxiangmuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报价金额" prop="yushuanbaojiaMoney">
                       <el-input v-model="ruleForm.yushuanbaojiaMoney"
                                 placeholder="报价金额" clearable  :readonly="ro.yushuanbaojiaMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="报价金额" prop="yushuanbaojiaMoney">
                           <el-input v-model="ruleForm.yushuanbaojiaMoney"
                                     placeholder="报价金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yushuanbaojiaMoney: [
                              { required: true, message: '报价金额不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yushuanbaojia/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yushuanbaojiaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
