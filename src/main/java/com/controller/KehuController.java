...
//                            kehuEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //账户
                        List<KehuEntity> kehuEntities_username = kehuService.selectList(new EntityWrapper<KehuEntity>().in("username", seachFields.get("username")).eq("kehu_delete", 1));
