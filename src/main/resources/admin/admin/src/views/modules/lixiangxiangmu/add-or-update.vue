    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目编号" prop="lixiangxiangmuUuidNumber">
                       <el-input v-model="ruleForm.lixiangxiangmuUuidNumber"
                                 placeholder="项目编号" clearable  :readonly="ro.lixiangxiangmuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目名称" prop="lixiangxiangmuName">
                       <el-input v-model="ruleForm.lixiangxiangmuName"
                                 placeholder="项目名称" clearable  :readonly="ro.lixiangxiangmuName"></el-input>
                   </el-form-item>
                   <div v-else>
            ...
            <input id="kehuId" name="kehuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="项目类型" prop="lixiangxiangmuTypes">
                        <el-select v-model="ruleForm.lixiangxiangmuTypes" :disabled="ro.lixiangxiangmuTypes" placeholder="请选择项目类型">
                            <el-option
                                v-for="(item,index) in lixiangxiangmuTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lixiangxiangmuFile" label="项目文件" prop="lixiangxiangmuFile">
                        <file-upload
                                tip="点击上传项目文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.lixiangxiangmuFile?ruleForm.lixiangxiangmuFile:''"
                                @change="lixiangxiangmuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lixiangxiangmuFile" label="项目文件" prop="lixiangxiangmuFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.lixiangxiangmuFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    lixiangxiangmuUuidNumber: false,
                    lixiangxiangmuName: false,
                    yonghuId: false,
                    kehuId: false,
                    lixiangxiangmuTypes: false,
                    lixiangxiangmuFile: false,
                    lixiangxiangmuYesnoTypes: false,
                    lixiangxiangmuYesnoText: false,
                },
                ruleForm: {
                    lixiangxiangmuUuidNumber: new Date().getTime(),
                    lixiangxiangmuName: '',
                    yonghuId: '',
                    kehuId: '',
                    lixiangxiangmuTypes: '',
                    lixiangxiangmuFile: '',
                    lixiangxiangmuYesnoTypes: '',
                    lixiangxiangmuYesnoText: '',
                },
                lixiangxiangmuTypesOptions : [],
                lixiangxiangmuYesnoTypesOptions : [],
                kehuOptions : [],
                yonghuOptions : [],
                rules: {
                   lixiangxiangmuUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lixiangxiangmu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lixiangxiangmuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lixiangxiangmu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lixiangxiangmuYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lixiangxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lixiangxiangmuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            lixiangxiangmuFileUploadChange(fileUrls){
                this.ruleForm.lixiangxiangmuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
